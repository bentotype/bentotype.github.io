...
struct CreateExpenseView: View {
    ...
    // Prefilled data from scanner or edit
    var prefilledAmount: Double? = nil
    var prefilledExplanation: String? = nil
    var prefilledSplits: [UUID: Double]? = nil
    var expenseToEdit: ExpenseInfo? = nil
    
    init(groupId: UUID, members: [UserInfo], prefilledAmount: Double? = nil, prefilledExplanation: String? = nil, prefilledSplits: [UUID: Double]? = nil, expenseToEdit: ExpenseInfo? = nil, onComplete: @escaping () -> Void) {
        ...
        _viewModel = StateObject(wrappedValue: CreateExpenseViewModel(groupId: groupId, members: members, prefilledSplits: prefilledSplits, expenseToEdit: expenseToEdit))
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(viewModel.isEditing ? "Edit Proposal" : "New Expense")
            .toolbar {
