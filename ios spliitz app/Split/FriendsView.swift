...
struct FriendsView: View {
    ...
    var sortedFriends: [FriendsViewModel.FriendWithBalance] {
        if sortAlphabetically {
            return viewModel.friends.sorted { $0.friend.fullName.localizedCaseInsensitiveCompare($1.friend.fullName) == .orderedAscending }
        }
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        HStack {
                            ...
                            Button {
                                ...
                                Image(systemName: sortAlphabetically ? "textformat.abc" : "arrow.up.arrow.down")
                                    .font(.subheadline)
