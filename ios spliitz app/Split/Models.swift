...
struct ExpenseInfo: Codable, Identifiable, Equatable {
    let id: UUID
    var title: String?
    ...
    static func == (lhs: ExpenseInfo, rhs: ExpenseInfo) -> Bool {
        return lhs.id == rhs.id &&
               lhs.title == rhs.title &&
               lhs.explanation == rhs.explanation &&
               lhs.totalAmount == rhs.totalAmount &&
               lhs.payerId == rhs.payerId &&
...
// MARK: - Activity Models (formerly Notifications)
...
enum ActivityType: String, Codable {
    // Existing mapped to new names where applicable
    case friendRequest = "friend_req"
    case groupInvite = "group_invite"
    case expenseProposed = "expense_proposal" // Was expenseProposal
    case duesPaid = "paying_dues"             // Was payingDues
    case friends = "request_accepted"         // Was requestAccepted
    
    // New types from Matrix
    case expenseFinalized = "expense_finalized"
    case paymentDueCustom = "payment_due_custom"
    case paymentConfirmed = "payment_confirmed"
    case paymentDue7Days = "payment_due_7_days"
