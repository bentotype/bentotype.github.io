    ...
    var body: some View {
        NavigationStack {
                    ...
                    ScrollView {
                        VStack(spacing: 24) {
                            ...
                            VStack(alignment: .leading, spacing: 16) {
                                ...
                                if notificationsViewModel.isLoading && notificationsViewModel.activities.isEmpty {
                                    ProgressView()
                                        .frame(maxWidth: .infinity)
                                        .padding()
                                } else if notificationsViewModel.activities.isEmpty {
                                    ...
                                    LazyVStack(spacing: 12) {
                                        ForEach(notificationsViewModel.activities) { activity in
                                            Button {
                                                // Handle deep linking logic
                                                if activity.title.contains("Friend Request") || activity.message.contains("friend request") {
                    ...
                    .refreshable {
                        ...
                        await notificationsViewModel.fetchActivities()
                    }
                    .onAppear {
