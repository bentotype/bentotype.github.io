 ...
 */
console.log('%cApp Version: 1.1.20 - Theme: Modern Blue Glass', 'background: rgba(255, 255, 255, 0.8); color: #4f46e5; padding: 4px; border-radius: 4px; border: 1px solid rgba(79, 70, 229, 0.2); backdrop-filter: blur(4px);');
